...
PDDL_PROBLEM_PATH = 'C:/Python/MARL_lab/pddlgym_testing/pddlgym/pddlgym/pddl/'
...
COLAB_TRANSFORMS = PATH_TO_DATA_FOR_COLAB + "big_taxi_transformed_env_colab/"
